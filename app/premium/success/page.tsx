      ...
      <div className="max-w-md mx-auto pt-8">
        ...
        <div className="bg-gradient-to-br from-orange-500 to-red-600 rounded-2xl p-8 text-white shadow-2xl">
          ...
          <button 
            ...
            disabled={loading}
            className="w-full bg-white text-orange-600 py-4 rounded-xl font-bold text-lg active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed transition"
          >
        ...
        <div className="mt-4 text-center">
          <p className="text-xs text-gray-500">
            Need help? Contact support@mizoprep.com
          </p>
        </div>
      </div>
    </div>
